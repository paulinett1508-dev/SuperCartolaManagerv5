// SISTEMA DE EXPORTAÇÃO PONTOS CORRIDOS - MOBILE DARK HD v3.0.1
...
console.log(
  "[EXPORT-PONTOS-CORRIDOS-MOBILE] Sistema Mobile Dark HD v3.0.1 carregado",
);
...
export async function criarBotaoExportacaoPontosCorridosRodada(config) {
  ...
  if (!container) {
    console.error(
      `[EXPORT-PONTOS-CORRIDOS-MOBILE] Container ${containerId} não encontrado`,
    );
    return;
  }
...
console.log(
  "[EXPORT-PONTOS-CORRIDOS-MOBILE] Sistema Mobile Dark HD configurado",
);
console.log(
  "[EXPORT-PONTOS-CORRIDOS-MOBILE] Resolução: 400px x 800px+ @ 4x scale",
);
console.log(
  "[EXPORT-PONTOS-CORRIDOS-MOBILE] Compatibilidade com sistema existente mantida",
);
